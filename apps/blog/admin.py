...
class BlogCategoryAdmin(admin.ModelAdmin):
    ...
    fields = ['name', 'image_tag', 'image','meta_description', 'meta_keywords']
...
class ArticleAdmin(admin.ModelAdmin):
    list_display = ['id', 'title', 'category_links', 'tag_links', 'user', 'publish_date', 'created_at']
    list_display_links = ['id', 'title']
    list_filter = ['category', 'tags']

    def category_links(self, instance):
    ...
    category_links.short_description = 'Категория'
